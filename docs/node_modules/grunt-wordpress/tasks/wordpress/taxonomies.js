...
module.exports.init = function( grunt ) {
	...
	//[[OLDCODE:hyunsook.park by updated]] - Change from grunt.registerHelper( "wordpress-validate-terms", ...) to exports.wordpress_get_postpaths().
	...
	//[[OLDCODE:hyunsook.park by updated]] - Change from grunt.registerHelper( "wordpress-get-terms", ... ) to exports.wordpress_get_terms().
	...
	//[[OLDCODE:hyunsook.park by updated]] - Change from grunt.registerHelper( "wordpress-publish-term", ... ) to exports.wordpress_publish_term().
	...
	//[[OLDCODE:hyunsook.park by updated]] - Change from grunt.registerHelper( "wordpress-delete-term", ... ) to exports.wordpress_delete_term().
	...
	//[[OLDCODE:hyunsook.park by updated]] - Change from grunt.registerHelper( "wordpress-sync-terms", ... ) to exports.wordpress_sync_terms().
	...
	exports.wordpress_sync_terms = function( filepath, fn ) {
		...
		async.waterfall([
			function getTerms( fn ) {
				//[[OLDCODE:hyunsook.park by updated]] - Use wordpress_get_terms() instead of grunt.helper( "wordpress-get-terms", ... ).
				...
				async.forEachSeries( Object.keys( taxonomies ), function( taxonomy, fn ) {
					...
					function process( terms, parent, fn ) {
						async.forEachSeries( terms, function( term, fn ) {
							...
							//[[OLDCODE:hyunsook.park by updated]] - Use exports.wordpress_publish_term() instead of grunt.helper( "wordpress-publish-term", ... ).
			...
			function deleteTerms( termMap, existingTerms, fn ) {
				...
				async.map( Object.keys( existingTerms ), function( taxonomy, fn ) {
					...
					async.forEachSeries( Object.keys( terms ), function( term, fn ) {
						//[[OLDCODE:hyunsook.park by updated]] - Use exports.wordpress_delete_term() instead of grunt.helper( "wordpress-delete-term", ... ).
