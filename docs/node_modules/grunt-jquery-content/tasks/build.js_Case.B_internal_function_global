...
module.exports.wordpress_parse_post_flex = function( grunt, path ) {
	var index,
		...
		//[[--Case1. If posts.js is "moduile.exports = function(grunt)":hyunsook.park by updated]]
		//helperWordpressParsePost = require( "grunt-wordpress/tasks/wordpress/posts" ).wordpress_parse_post;
		//[[--Case2. If posts.js is "moduile.exports.init = function(grunt)":hyunsook.park by updated]]
		helperWordpressParsePost = require( "grunt-wordpress/tasks/wordpress/posts" ).init( grunt ).wordpress_parse_post;
//console.log( "@@@@@@>>>>>>" + helperWordpressParsePost );
	...
	//[[ADDCODE:hyunsook.park by updated]]
	//[[--Case1. If posts.js is "moduile.exports = function(grunt)":hyunsook.park by updated]]
	//return helperWordpressParsePost( grunt, path );
	//[[--Case2. If posts.js is "moduile.exports.init = function(grunt)":hyunsook.park by updated]]
